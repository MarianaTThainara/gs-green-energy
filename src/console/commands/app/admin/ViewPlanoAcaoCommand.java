...
public class ViewPlanoAcaoCommand extends AppCommand {
    ...
    public void run() {
        ...
        for(PlanoAcao plano : planosAcao) {
            System.out.printf(
                    "Nome: %s | Tipo: %s | Status: %s | Estado: %s | Data início: %s | Meta: %s | Meta Adesão Mínima: %.2f | Recompensa Verde: %.2f | Data Criação: %s | Data Alteração: %s",
                    plano.getNome(),
